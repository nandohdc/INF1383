<div class="container">
    <form method="" role="" class="form-horizontal">
        <div class="row">
            <fieldset>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Digite o seu nome completo" id="example-text-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-search-input" class="col-xs-2 col-form-label">CPF</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Exemplo: xxxxxxxxx-xx" id="example-search-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-email-input" class="col-xs-2 col-form-label">Identidade</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Exemplo xxxxxxxx-xx" id="example-email-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-url-input" class="col-xs-2 col-form-label">Órgão Emissor</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="url" placeholder="Exemplo: DETRAN" id="example-url-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-tel-input" class="col-xs-2 col-form-label">Matrícula</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="tel" placeholder="Exemplo: (xx)xxxx-xxxx" id="example-tel-input">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Exemplo: xx/xx/xxxx" id="example-number-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-datetime-local-input" class="col-xs-2 col-form-label">Período</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="number" placeholder="Digite o seu período" id="example-datetime-local-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-date-input" class="col-xs-2 col-form-label">E-mail</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="email" placeholder="Digite o seu email." id="example-date-input">
                  </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Digite o nome de sua rua" id="example-text-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-search-input" class="col-xs-2 col-form-label">Complemento</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Digite o número de sua casa ou, prédio e apto." id="example-search-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-email-input" class="col-xs-2 col-form-label">Bairro</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Digite o seu bairro." id="example-email-input">
                  </div>
                </div>
                <div class="form-group row">
                  <label for="example-url-input" class="col-xs-2 col-form-label">Cidade</label>
                  <div class="col-xs-10">
                    <input class="form-control" type="url" placeholder="Digite a cidade onde mora." id="example-url-input">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-10">
 					<input class="form-control" type="text" placeholder="Exemplo: xxxxx-xxx" id="example-number-input">
                  </div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-xs-10">
                    <input class="form-control" type="text" placeholder="Exemplo: xx/xx/xxxxx" id="example-tel-input">
                  </div>
                </div>
                <div class="form-group row">
             ...
             <div class="row text-center">
               <button type="" class="btn btn-success" id="btn-submit">Enviar</button>
            </div> 
        </div>
    </form>
</div>